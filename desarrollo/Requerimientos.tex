...
\textbf{Inicio de sesión}: El sistema deberá permitir el inicio de sesión únicamente a los usuarios que hayan sido previamente registrados en el módulo correspondiente por un usuario con permisos de administrador o supervisor (Tabla \ref{tab:req_sesion}).
...
\textbf{Gestión de usuarios}: El sistema deberá permitir a los usuarios con rol de administrador o supervisor gestionar las cuentas de usuario del módulo, incluyendo la creación, modificación y eliminación de usuarios (Tabla \ref{tab:req_usuarios}).
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
        ...
        Descripción general     & El sistema deberá permitir a los usuarios con rol de administrador o supervisor crear, modificar y eliminar cuentas de usuario dentro del módulo correspondiente, así como asignar los permisos de acceso según el rol definido. \\ \hline
        Prioridad               & Alta                                                                                                                                                                                                                             \\ \hline
    \end{tabularx}
\end{table}

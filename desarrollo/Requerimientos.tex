...
\textbf{Inicio de sesión}: El sistema deberá permitir el inicio de sesión únicamente a los usuarios que hayan sido previamente registrados en el módulo correspondiente por un usuario con permisos de administrador o supevisor (Tabla \ref{tab:req_sesion}).
